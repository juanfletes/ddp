...
class ParametrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post parametros_url, params: { parametro: { codigo: @parametro.codigo, nombre: @parametro.nombre, valor: @parametro.valor } }
    end
  ...
  test "should update parametro" do
    patch parametro_url(@parametro), params: { parametro: { codigo: @parametro.codigo, nombre: @parametro.nombre, valor: @parametro.valor } }
